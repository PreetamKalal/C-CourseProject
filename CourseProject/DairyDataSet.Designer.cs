...
namespace CourseProject {
    ...
    public partial class DairyDataSet : global::System.Data.DataSet {
        ...
        public partial class LoginTableDataTable : global::System.Data.TypedTableBase<LoginTableRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public LoginTableRow AddLoginTableRow(string UserName, string Email, string Password, string FirstName, string LastName) {
        ...
        public partial class LoginTableRow : global::System.Data.DataRow {
            ...
            public string FirstName {
                get {
                    return ((string)(this[this.tableLoginTable.FirstNameColumn]));
                }
                set {
                    this[this.tableLoginTable.FirstNameColumn] = value;
                }
            }
            ...
            public string LastName {
                get {
                    return ((string)(this[this.tableLoginTable.LastNameColumn]));
                }
                set {
                    this[this.tableLoginTable.LastNameColumn] = value;
                }
            }
        }
...
namespace CourseProject.DairyDataSetTableAdapters {
    ...
    public partial class LoginTableTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[LoginTable] WHERE (([Id] = @Original_Id) AND ([UserName] = @Or" +
                "iginal_UserName) AND ([Email] = @Original_Email) AND ([Password] = @Original_Pas" +
                "sword) AND ([FirstName] = @Original_FirstName) AND ([LastName] = @Original_LastN" +
                "ame))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[LoginTable] ([Id], [UserName], [Email], [Password], [FirstName" +
                "], [LastName]) VALUES (@Id, @UserName, @Email, @Password, @FirstName, @LastName)" +
                ";\r\nSELECT Id, UserName, Email, Password, FirstName, LastName FROM LoginTable WHE" +
                "RE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[LoginTable] SET [Id] = @Id, [UserName] = @UserName, [Email] = @Email, [Password] = @Password, [FirstName] = @FirstName, [LastName] = @LastName WHERE (([Id] = @Original_Id) AND ([UserName] = @Original_UserName) AND ([Email] = @Original_Email) AND ([Password] = @Original_Password) AND ([FirstName] = @Original_FirstName) AND ([LastName] = @Original_LastName));
SELECT Id, UserName, Email, Password, FirstName, LastName FROM LoginTable WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::CourseProject.Properties.Settings.Default.DairyConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT UserName, Email, Password, FirstName, LastName FROM LoginTable";
        ...
        public virtual int Fill(DairyDataSet.LoginTableDataTable dataTable) {
        ...
        public virtual DairyDataSet.LoginTableDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            DairyDataSet.LoginTableDataTable dataTable = new DairyDataSet.LoginTableDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DairyDataSet.LoginTableDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Id, string Original_UserName, string Original_Email, string Original_Password, string Original_FirstName, string Original_LastName) {
        ...
        public virtual int Insert(int Id, string UserName, string Email, string Password, string FirstName, string LastName) {
        ...
        public virtual int Update(int Id, string UserName, string Email, string Password, string FirstName, string LastName, int Original_Id, string Original_UserName, string Original_Email, string Original_Password, string Original_FirstName, string Original_LastName) {
